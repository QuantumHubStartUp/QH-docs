...
export const Header: React.FC = () => {
    return (
        <header className={`sticky top-0 left-0 right-0 ${ELayoutCSS.LEVEL_2} bg-[var(--color-muted)] text-[var(--color-text)] dark:bg-[var(--color-bg)] dark:text-[var(--color-text)] shadow-md min-h-[50px]`}>  
