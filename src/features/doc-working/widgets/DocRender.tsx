...
export const DocRender = () => {
    ...
    return (
        <section className="p-4 md:p-8 rounded-2xl bg-linear-to-r from-cyan-500 to-gray-500 bg-black/80 backdrop-blur-md shadow-md border-solid border-2 border-black">
